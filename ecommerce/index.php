...
<!-- Mirrored from ledthanhdat.vn/html/lynessa/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 18:10:11 GMT -->
<?php 
include "css.php";
?>
<body>
            ...
            <div class="row">
                    ...
                    <div class="lynessa-banner style-04 left-center">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img src="../assets/images/banner244.jpg"
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="lynessa-banner style-04 left-center">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img src="../assets/images/banner252.jpg"
                                     class="attachment-full size-full" alt="img">
                            </figure>
                            <div class="banner-info ">
                                <div class="banner-content">
        ...
        <div class="container">
            ...
            <div class="lynessa-products style-04">
                <div class="response-product product-list-owl owl-slick equal-container better-height"
                    ...
                    <div class="product-item recent-product style-04 rows-space-0 post-49 product type-product status-publish has-post-thumbnail product_cat-light product_cat-bed product_cat-sofas product_tag-multi product_tag-lamp  instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link"
                                   href="#" tabindex="0">
                    ...
                    <div class="product-item recent-product style-04 rows-space-0 post-37 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-bed product_tag-light product_tag-hat product_tag-sock last instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#"
                                   tabindex="0">
                                    <img class="img-responsive"
                                         ...
                                         alt="KNIT CARDIGAN" width="270" height="350">
                                </a>
                                <div class="flash">
                                    <span class="onnew"><span class="text">New</span></span></div>
                                <div class="group-button">
                    ...
                    <div class="product-item recent-product style-04 rows-space-0 post-35 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-new-arrivals product_cat-lamp product_tag-light product_tag-hat product_tag-sock first instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#"
                                   tabindex="0">
                    ...
                    <div class="product-item recent-product style-04 rows-space-0 post-36 product type-product status-publish has-post-thumbnail product_cat-table product_cat-bed product_tag-light product_tag-table product_tag-sock  instock sale shipping-taxable purchasable product-type-simple">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#"
                                   tabindex="-1">
                                    <img class="img-responsive"
                                         ...
                                         alt="SPORTY HOODIE" width="270" height="350">
                                </a>
                                <div class="flash">
                            ...
                            <div class="product-info">
                                ...
                                <span class="price"><del><span class="lynessa-Price-amount amount"><span
                                        class="lynessa-Price-currencySymbol">$</span>125.00</span></del> <ins><span
                    ...
                    <div class="product-item recent-product style-04 rows-space-0 post-34 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock last instock sale featured shipping-taxable product-type-grouped">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#"
                                   tabindex="-1">
                                    <img class="img-responsive"
                                         ...
                                         alt="INSERT TANK" width="270" height="350">
                                </a>
                                <div class="flash">
                                    <span class="onnew"><span class="text">New</span></span></div>
                                <div class="group-button">
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link" href="#"
                                           tabindex="0">
                                            <img class="img-responsive"
                                                 src="../assets/images/apro51012-1-275x310.jpg"
                ...
                <span class="process" style="width: 13%"></span>
                                        ...
                                        <div class="add-to-cart">
                                            <a href="http://ledthanhdat.vn/lynessa/home-02/?add-to-cart=36" data-quantity="1"
                            ...
                            <div class="product-item on_sale style-03 rows-space-0 post-32 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-hat product_tag-sock  instock sale featured shipping-taxable purchasable product-type-simpl"
                                 data-slick-index="1" style="margin-right: 30px; width: 520px;" aria-hidden="false"
                                ...
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#" tabindex="0">
                                            <img class="img-responsive"
                                                 src="../assets/images/apro71-1-275x310.jpg"
                                                 alt="MINI SKIRT" width="275" height="310">
                                        </a>
                                    </div>
                                    <div class="product-info equal-elem" >
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="0">MINI SKIRT</a>
                                        </h3>
                                        <span class="price"><del><span class="lynessa-Price-amount amount"><span
                ...
                <span class="process" style="width: 50%"></span>
                                        ...
                                        <div class="countdown-product">
                                            <div class="lynessa-countdown" data-datetime="03/12/2021 12:00:00"><span
                                                    class="days"><span class="number">127</span><span
                                                    class="text">Days</span></span><span
                                                    class="hour"><span class="number">21</span><span
                                                    class="text">Hours</span></span><span
                                                    class="mins"><span class="number">55</span><span
                                        ...
                                        <div class="add-to-cart">
                                            <a href="http://ledthanhdat.vn/lynessa/home-02/?add-to-cart=32" data-quantity="1"
                                               class="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                               data-product_id="32" data-product_sku="009U199"
                                               aria-label="Add “MINI SKIRT” to your cart" rel="nofollow"
                                               tabindex="0">Add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="product-item on_sale style-03 rows-space-0 post-28 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-sock last instock sale featured shipping-taxable purchasable product-type-simple"
                                 data-slick-index="2" style="margin-right: 30px; width: 520px;" aria-hidden="true"
                                ...
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 src="../assets/images/apro1211-2-275x310.jpg"
                                                 alt="SLEEVELESS TOP" width="275" height="310">
                                        </a>
                                    </div>
                                    <div class="product-info equal-elem"  >
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">SLEEVELESS TOP</a>
                                        </h3>
                                        <span class="price"><del><span class="lynessa-Price-amount amount"><span
                ...
                <span class="process" style="width: 9%"></span>
                                        ...
                                        <div class="countdown-product">
                                            <div class="lynessa-countdown" data-datetime="11/29/2020 12:00:00"><span
                                                    class="days"><span class="number">389</span><span
                                                    class="text">Days</span></span><span
                                                    class="hour"><span class="number">21</span><span
                                                    class="text">Hours</span></span><span
                                                    class="mins"><span class="number">55</span><span
                                        ...
                                        <div class="add-to-cart">
                                            <a href="http://ledthanhdat.vn/lynessa/home-02/?add-to-cart=28" data-quantity="1"
                                               class="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                               data-product_id="28" data-product_sku="005K938"
                                               aria-label="Add “SLEEVELESS TOP” to your cart" rel="nofollow"
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="0">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="INSERT SINGLET" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="0">INSERT SINGLET</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="0">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="MINI SKIRT" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                            ...
                            <div class="product-item best-selling style-06 rows-space-30 post-20 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_cat-specials product_tag-table product_tag-hat product_tag-sock first instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <span class="price"><del><span
                                                class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>150.00</span></del> <ins><span
                                                class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>139.00</span></ins></span>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="SPORTY HOODIE" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">SPORTY HOODIE</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="MARIE CAMI" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="KNIT LIKE" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="SLEEVELESS TOP" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="BASIC SINGLET" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">BASIC SINGLET</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="lynessa-products style-06">
                        ...
                        <div class="response-product product-list-owl owl-slick equal-container better-height"
                             data-slick="{&quot;arrows&quot;:true,&quot;slidesMargin&quot;:30,&quot;dots&quot;:false,&quot;infinite&quot;:false,&quot;speed&quot;:300,&quot;slidesToShow&quot;:1,&quot;rows&quot;:3}"
                             data-responsive="[{&quot;breakpoint&quot;:480,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;10&quot;}},{&quot;breakpoint&quot;:768,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;10&quot;}},{&quot;breakpoint&quot;:992,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesMargin&quot;:&quot;20&quot;}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;20&quot;}},{&quot;breakpoint&quot;:1500,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;30&quot;}}]">
                            <div class="product-item top-rated style-06 rows-space-30 post-26 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-hat first instock featured shipping-taxable product-type-external">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-28 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-sock  instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-32 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-hat product_tag-sock last instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="Glasses" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">WIDE PANTS</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-21 product type-product status-publish has-post-thumbnail product_cat-light product_cat-bed product_cat-lamp product_tag-light product_tag-sock last outofstock featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="WIDE PANTS" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-34 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock first instock sale featured shipping-taxable product-type-grouped">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="INSERT TANK" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">INSERT TANK</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-22 product type-product status-publish has-post-thumbnail product_cat-table product_cat-bed product_cat-lamp product_tag-table product_tag-hat product_tag-sock  instock featured downloadable shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item top-rated style-06 rows-space-30 post-35 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-new-arrivals product_cat-lamp product_tag-light product_tag-hat product_tag-sock last instock shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="lynessa-products style-06">
                        ...
                        <div class="response-product product-list-owl owl-slick equal-container better-height"
                             data-slick="{&quot;arrows&quot;:true,&quot;slidesMargin&quot;:30,&quot;dots&quot;:false,&quot;infinite&quot;:false,&quot;speed&quot;:300,&quot;slidesToShow&quot;:1,&quot;rows&quot;:3}"
                             data-responsive="[{&quot;breakpoint&quot;:480,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;10&quot;}},{&quot;breakpoint&quot;:768,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;10&quot;}},{&quot;breakpoint&quot;:992,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesMargin&quot;:&quot;20&quot;}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;20&quot;}},{&quot;breakpoint&quot;:1500,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesMargin&quot;:&quot;30&quot;}}]">
                            <div class="product-item featured_products style-06 rows-space-30 post-34 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock first instock sale featured shipping-taxable product-type-grouped">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item featured_products style-06 rows-space-30 post-32 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-hat product_tag-sock  instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                        ...
                                        <a class="thumb-link"
                                           ...
                                           tabindex="0">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="STRIPE SKIRTS" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                            ...
                            <div class="product-item featured_products style-06 rows-space-30 post-31 product type-product status-publish has-post-thumbnail product_cat-light product_cat-sofas product_tag-hat first instock sale featured shipping-taxable product-type-grouped">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="Swing Dress" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">Swing Dress</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                                        ...
                                        <span class="price"><span
                                                class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>89.00</span> – <span
                                                class="lynessa-Price-amount amount"><span
                                                class="lynessa-Price-currencySymbol">$</span>139.00</span></span>
                                    </div>
                                </div>
                            </div>
                            <div class="product-item featured_products style-06 rows-space-30 post-29 product type-product status-publish has-post-thumbnail product_cat-new-arrivals product_cat-specials product_tag-light product_tag-sock  instock featured downloadable shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                                           tabindex="-1">
                                            <img class="img-responsive"
                                                 ...
                                                 alt="Abstract Sweatshirt" width="90" height="90">
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h3 class="product-name product_title">
                                            <a href="#"
                                               tabindex="-1">Abstract Sweatshirt</a>
                                        </h3>
                                        <div class="rating-wapper nostar">
                                            <div class="star-rating"><span
                                                    style="width:0%">Rated <strong
                            ...
                            <div class="product-item featured_products style-06 rows-space-30 post-28 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-sock last instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item featured_products style-06 rows-space-30 post-26 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-hat first instock featured shipping-taxable product-type-external">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
                            ...
                            <div class="product-item featured_products style-06 rows-space-30 post-25 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-specials product_tag-light product_tag-sock  instock sale featured shipping-taxable purchasable product-type-simple">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <a class="thumb-link"
                                           href="#"
...
<!-- Mirrored from ledthanhdat.vn/html/lynessa/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 18:13:46 GMT -->
</html>